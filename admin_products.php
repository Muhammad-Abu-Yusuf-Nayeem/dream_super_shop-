...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, type) VALUES('$name', '$price', '$image','$type')") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="type" class="box" required>
         ...
         <option value="great_savings">great_savings</option>
         ...
         <option value="Cooking_Essentials">Cooking_Essentials</option>
         <option value="Snacks">Snacks</option>
         <option value="Dairy">Dairy</option>
         <option value="Personal">Personal</option>
         <option value="Pet_care">Pet_care</option>
      </select>
